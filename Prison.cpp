...
Prison::Prison() {
	...
	*/
	...
	//enemies
	//JP3: Incompatiable change, only one Item is allowed per new Enemy oject
	...
	Enemy* josh = new Enemy("Josh", "Bad Guy", "ENEMY", 20, 5, Item("Pills", "Pills...I dont do drugs but maybe I can trade these", Item_Types[6]));
